    ...
    <>
      <div className="flex gap-4">
        <button
          ...
          className="border-border dark:border-darkborder text-dark dark:border-darkborder dark:hover:bg-primary/10 hover:bg-primary/10 flex w-full items-center justify-center gap-2.5 rounded-lg border p-3.5 duration-200 ease-in dark:text-white"
        >
          Sign Up
          <svg
            width="23"
